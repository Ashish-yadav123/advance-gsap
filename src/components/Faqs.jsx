...
const Faqs = () => {
  return (
    <div>
      <div className="section_7 min-h-screen bg-[red] text-start text-white flex items-center justify-center">
        <div className="container px-5 xl:max-w-[1170px] 2xl:max-w-[1320px] py-12 sm:py-0">
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between">
            <div className="w-full md:w-[48%]">
              <h1 className="text-4xl">FAQS ANIMATION PARENT</h1>
              <p>
            ...
            <div className="w-full md:w-[48%] flex items-center justify-center md:justify-end mt-5 md:mt-0">
