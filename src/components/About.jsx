...
const About = () => {
  return (
    <div>
      <div className="section_ 2 min-h-screen bg-[green] text-start text-white flex items-center justify-center">
        <div className="container px-5 xl:max-w-[1170px] 2xl:max-w-[1320px] py-12 sm:py-0">
          <div className="flex flex-col md:flex-row items-center justify-center md:justify-between">
            ...
            <div className="w-full md:w-[48%] flex justify-center md:justify-end mt-5 md:mt-0">
